...
$Id =  'SELECT codigoart,descripcion,existencia,precio_venta,codigo_proveedor FROM articulo order by codigoart ASC';
...
if($r>0){
	...
	$pdf->Cell(90,8,'INVENTARIO DE TODOS LOS PRODUCTOS ',0,1,'c');
	$pdf->Ln();
